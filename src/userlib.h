...
public:
    ...
    static void* mmap(uint64 addr, uint64 len, uint32 prot, uint32 flags);
    ...
    static int64 read(int fd, void* buf, uint64 size);
    static int64 write(int fd, void* buf, uint64 size);
